...
export default function OrderForm() {
  ...
  const handleAddDesign = () => {
    ...
    if (Object.keys(newErrors).length > 0) {
      setErrors(newErrors);
      alert('Please fill in all required fields: Design Type, Design Number, Finishing, Size, and Nos');
      return;
    }
    
    // Clear errors and save design
    setErrors({});
    setSavedDesigns([...savedDesigns, { ...currentDesign, id: savedDesigns.length + 1 }]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            <div className="relative">
              <select
                ...
                onChange={(e) => {
                  setCurrentDesign({...currentDesign, designType: e.target.value});
                  setErrors({...errors, designType: false});
                }}
                className={`w-full px-4 py-3 border ${errors.designType ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none bg-white peer`}
              >
              ...
              <label className={`absolute left-3 -top-2.5 bg-white px-1 text-sm ${errors.designType ? 'text-red-500' : 'text-gray-600'}`}>
            ...
            <div className="relative">
              <select
                ...
                onChange={(e) => {
                  setCurrentDesign({...currentDesign, designNo: e.target.value});
                  setErrors({...errors, designNo: false});
                }}
                className={`w-full px-4 py-3 border ${errors.designNo ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none bg-white`}
              >
                <option value="">Select Type</option>
              ...
              <label className={`absolute left-3 -top-2.5 bg-white px-1 text-sm ${errors.designNo ? 'text-red-500' : 'text-gray-600'}`}>
            ...
            <div className="relative">
              <select
                ...
                onChange={(e) => {
                  setCurrentDesign({...currentDesign, finishing: e.target.value});
                  setErrors({...errors, finishing: false});
                }}
                className={`w-full px-4 py-3 border ${errors.finishing ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none bg-white`}
              >
              ...
              <label className={`absolute left-3 -top-2.5 bg-white px-1 text-sm ${errors.finishing ? 'text-red-500' : 'text-gray-600'}`}>
          ...
          <div className="mb-6">
            <div className={`relative border ${errors.size || errors.nos ? 'border-red-500' : 'border-gray-300'} rounded-md p-4`}>
              <label className={`absolute left-3 -top-2.5 bg-white px-1 text-sm ${errors.size || errors.nos ? 'text-red-500' : 'text-gray-600'}`}>
                Panel : {(errors.size || errors.nos) && <span className="text-red-500">*</span>}
              </label>
              <div className="grid grid-cols-2 gap-4">
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => {
                      setCurrentDesign({...currentDesign, size: e.target.value});
                      setErrors({...errors, size: false});
                    }}
                    placeholder="0"
                    className={`w-full px-3 py-2 border ${errors.size ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}
                  />
                  <label className={`absolute left-3 -top-2.5 bg-white px-1 text-xs ${errors.size ? 'text-red-500' : 'text-gray-600'}`}>
                    Size {errors.size && <span className="text-red-500">*</span>}
                  </label>
                </div>
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => {
                      setCurrentDesign({...currentDesign, nos: e.target.value});
                      setErrors({...errors, nos: false});
                    }}
                    placeholder="0"
                    className={`w-full px-3 py-2 border ${errors.nos ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500`}
                  />
                  <label className={`absolute left-3 -top-2.5 bg-white px-1 text-xs ${errors.nos ? 'text-red-500' : 'text-gray-600'}`}>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setCurrentDesign({
                      ...currentDesign,
                      aSection: {...currentDesign.aSection, small: e.target.value}
                    })}
                    placeholder="0"
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setCurrentDesign({
                      ...currentDesign,
                      aSection: {...currentDesign.aSection, big: e.target.value}
                    })}
                    placeholder="0"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setCurrentDesign({
                      ...currentDesign,
                      aSection: {...currentDesign.aSection, large: e.target.value}
                    })}
                    placeholder="0"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setCurrentDesign({
                      ...currentDesign,
                      frame: {...currentDesign.frame, small: e.target.value}
                    })}
                    placeholder="0"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setCurrentDesign({
                      ...currentDesign,
                      frame: {...currentDesign.frame, big: e.target.value}
                    })}
                    placeholder="0"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => setCurrentDesign({
                      ...currentDesign,
                      frame: {...currentDesign.frame, large: e.target.value}
                    })}
                    placeholder="0"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
          ...
          <div key={design.id} className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                <FileText className="w-5 h-5" />
                <h2 className="text-lg font-semibold">Design Details - SL - 0{design.id}</h2>
              </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="grid grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">{design.panel || '0'}</span>
                </div>
                <div>
              ...
              <div className="grid grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">{design.aSection.small || '0'}</span>
                </div>
                <div>
                  <span className="text-gray-600">Big</span>
                  <span className="ml-2 font-medium">{design.aSection.big || '0'}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-6">
                ...
                <div>
                  <span className="text-gray-600">Big</span>
                  <span className="ml-2 font-medium">{design.frame.big || '0'}</span>
                </div>
                <div>
                  <span className="text-gray-600">Large</span>
                  <span className="ml-2 font-medium">{design.aSection.large || '0'}</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-6">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">{design.frame.small || '0'}</span>
                </div>
                <div>
                  <span className="text-gray-600">Small</span>
                  <span className="ml-2 font-medium">{design.frame.small || '0'}</span>
              ...
              <div className="grid grid-cols-4 gap-6">
                ...
                <div>
                  <span className="text-gray-600">Large</span>
                  <span className="ml-2 font-medium">{design.frame.large || '0'}</span>
                </div>
                <div>
                  <span className="text-gray-600">Large</span>
                  <span className="ml-2 font-medium">{design.frame.large || '0'}</span>
