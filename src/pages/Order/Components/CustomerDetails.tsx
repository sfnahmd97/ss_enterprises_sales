...
export default function CustomerDetails({
  ...
  const handleCustomerChange = async (selectedOption: SelectOption | null) => {
    if (selectedOption) {
      setFormData({
        ...formData,
      ...
      try {
        const res = await api.get(
          `sales/get-customer-details/${selectedOption.value}`
        );
        const data = (res.data as { data: any }).data;

        setFormData((prev: any) => ({
          ...prev,
          place: data.full_location || "",
